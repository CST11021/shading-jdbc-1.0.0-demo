...
public final class ShardingPreparedStatement extends AbstractPreparedStatementAdapter {
    ...
    public ShardingPreparedStatement(final SQLRouteEngine sqlRouteEngine, final ShardingConnection shardingConnection, final String sql, final int resultSetType, final int resultSetConcurrency) throws SQLException {
        this(sqlRouteEngine, shardingConnection, sql, resultSetType, resultSetConcurrency, ResultSet.HOLD_CURSORS_OVER_COMMIT);
    }
    public ShardingPreparedStatement(final SQLRouteEngine sqlRouteEngine, final ShardingConnection shardingConnection, final String sql, final int resultSetType, final int resultSetConcurrency, final int resultSetHoldability) throws SQLException {
    ...
    private List<PreparedStatement> routeSQL(final List<Object> parameters) throws SQLException {
        ...
        for (SQLExecutionUnit sqlExecutionUnit : sqlRouteResult.getExecutionUnits()) {
            PreparedStatement preparedStatement = generatePrepareStatement(
                    getShardingConnection().getConnection(sqlExecutionUnit.getDataSource()),
