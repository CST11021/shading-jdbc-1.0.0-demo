...
public final class ShardingRule {
    ...
    public ShardingRule(final DataSourceRule dataSourceRule, final Collection<TableRule> tableRules) {
        this(dataSourceRule, tableRules, Collections.<BindingTableRule>emptyList(), new DatabaseShardingStrategy(Collections.<String>emptyList(), new NoneDatabaseShardingAlgorithm()), new TableShardingStrategy(Collections.<String>emptyList(), new NoneTableShardingAlgorithm()));
    }
    public ShardingRule(final DataSourceRule dataSourceRule, final Collection<TableRule> tableRules, final Collection<BindingTableRule> bindingTableRules) {
        this(dataSourceRule, tableRules, bindingTableRules, new DatabaseShardingStrategy(Collections.<String>emptyList(), new NoneDatabaseShardingAlgorithm()), new TableShardingStrategy(Collections.<String>emptyList(), new NoneTableShardingAlgorithm()));
    }
    public ShardingRule(final DataSourceRule dataSourceRule, final Collection<TableRule> tableRules, final DatabaseShardingStrategy databaseShardingStrategy) {
        this(dataSourceRule, tableRules, Collections.<BindingTableRule>emptyList(), databaseShardingStrategy, new TableShardingStrategy(Collections.<String>emptyList(), new NoneTableShardingAlgorithm()));
    }
    public ShardingRule(final DataSourceRule dataSourceRule, final Collection<TableRule> tableRules, final TableShardingStrategy tableShardingStrategy) {
        this(dataSourceRule, tableRules, Collections.<BindingTableRule>emptyList(), new DatabaseShardingStrategy(Collections.<String>emptyList(), new NoneDatabaseShardingAlgorithm()), tableShardingStrategy);
    }
    public ShardingRule(final DataSourceRule dataSourceRule, final Collection<TableRule> tableRules, final DatabaseShardingStrategy databaseShardingStrategy, final TableShardingStrategy tableShardingStrategy) {
